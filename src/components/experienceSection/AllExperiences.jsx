...
const experiences = [
  {
    ...
    company: "Paihar India Pvt. Ltd.",
    date: "feb 2025 - April 2025",
    location: "Remote",
    status: "Completed",
    technologies: ["React", "JavaScript", "Node.js", "Tailwind CSS"," MongoDB"],
    responsibilities: [
      "Developed and maintained responsive websites using MERN stack",
    ...
    link: "https://pariharindia.com/"
  },
  {
    job: "software Engineer Intern",
    company: "Vituenexa Solutions",
    date: "2024 - 2025",
    location: "India",
    status: "Completed",
    technologies: ["HTML", "CSS", "JavaScript", "Framer", "React", "Node.js", "Express", "MongoDB"],
    responsibilities: [
      "Assisted with building a RESTful backend in Node.js/Express for an online learning-management platform",
      "Developed and maintained React.js components for student dashboards, course catalogs, and quiz modules ",
      "Implemented JWT-based authentication & role-based access control (students vs. instructors)",
      "Collaborated with design team to ensure pixel-perfect implementation",
      "Integrated real-time notifications (attendance alerts, assignment reminders) using Socket.io"
    ],
    link: "https://virtuexnexa.com/"
  },
  {
    ...
    <div className="mt-16">
      ...
      >
        ...
        <div className="flex justify-center gap-4">
          ...
          <a 
            href="https://www.linkedin.com/in/surenderdubey?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" 
            target="_blank" 
            rel="noopener noreferrer"
