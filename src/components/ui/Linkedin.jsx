...
const Button = () => {
  const handleClick = () => {
    window.location.href = "https://www.linkedin.com/in/surenderdubey?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"; // Replace with your LinkedIn profile link
  };
  return (
    <StyledWrapper>
